...
const Beginner = () => {
  ...
  const handleMonthSelect = (value: string, sessionsPerWeek: 1 | 3) => {
    ...
    setTotalCost(sessionsPerWeek === 3 ? 30 : 20);
  };
  ...
  const handleNext = () => {
    ...
    if (bookingType === "single") {
      setTotalCost(selectedDates.length * 6);
    }
    navigate("/details");
  };
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <h1 className="text-3xl font-bold text-center text-blue-600 mb-6">
          Book Beginner Group Sessions for Under 11s
        </h1>
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 border rounded-md bg-blue-50">
              ...
              <p className="mb-3">Will cost £30.00 per month (best option).</p>
              <Select 
            ...
            <div className="p-4 border rounded-md bg-blue-50">
              ...
              <p className="mb-3">Will cost £20.00 per month.</p>
              <Select 
            ...
            <div className="p-4 border rounded-md">
              ...
              <p className="mb-3">Will cost £6.00 each.</p>
              ...
              {bookingType === "single" && selectedDates.length > 0 && <div className="mt-4 p-3 bg-gray-50 rounded-md">
                  ...
                  <p className="mt-3 text-lg font-semibold">
                    Total: £{selectedDates.length * 6.00}
                  </p>
                </div>}
            </div>
          </div>
