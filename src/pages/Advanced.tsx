...
const Advanced = () => {
  ...
  const handleMonthSelect = (value: string, sessionsPerWeek: 1 | 3) => {
    ...
    setTotalCost(sessionsPerWeek === 3 ? 55 : 45);
  };
  ...
  const handleNext = () => {
    ...
    if (bookingType === "single") {
      setTotalCost(selectedDates.length * 15);
    }
    navigate("/details");
  };
        ...
        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
          ...
          <div className="space-y-6">
            <div className="p-4 border rounded-md bg-blue-50">
              ...
              <p className="mb-3">Will cost £55.00 per month (best option).</p>
              <Select 
            ...
            <div className="p-4 border rounded-md bg-blue-50">
              ...
              <p className="mb-3">Will cost £45.00 per month.</p>
              <Select 
            ...
            <div className="p-4 border rounded-md">
              ...
              <p className="mb-3">Will cost £15.00 each.</p>
              ...
              {bookingType === "single" && selectedDates.length > 0 && <div className="mt-4 p-3 bg-gray-50 rounded-md">
                  ...
                  <p className="mt-3 text-lg font-semibold">
                    Total: £{(selectedDates.length * 15).toFixed(2)}
                  </p>
                </div>}
            </div>
          </div>
